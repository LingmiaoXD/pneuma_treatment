...
if __name__ == "__main__":
    ...
    TRAJ_CSV_PATH = r"/home/nvme1/pneuma/data/trajectory_with_laneid/0127085746_0002.csv"  # 轨迹数据
    GRAPH_JSON_PATH = r"/home/nvme1/pneuma/data/road_graph/minhang_graph.json"  # 图结构（更新版本，包含lanes和nodes）
    OUTPUT_CSV = r"/home/nvme1/pneuma/data/lane_node_stats/k0127085746_0002_lane_node_stats_3.csv"  # 输出路径
