...
if __name__ == "__main__":
    ...
    # 示例路径（请根据实际情况修改）
    MASK_CSV_PATH = r"E:\大学文件\研二\交通分析\代码\pneuma_treatment\yolodata\minhang_lane_node_stats\k0127085746_0002_node_mask.csv"  # mask文件
    DYNAMIC_CSV_PATH = r"E:\大学文件\研二\交通分析\代码\pneuma_treatment\yolodata\minhang_lane_node_stats\k0127085746_0002_lane_node_stats_3.csv"  # dynamic文件
    OUTPUT_CSV = r"E:\大学文件\研二\交通分析\代码\pneuma_treatment\yolodata\minhang_lane_node_stats\k0127085746_0002_lane_node_stats.csv"  # 输出路径
