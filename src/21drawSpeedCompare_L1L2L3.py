...
def main():
    ...
    # 输出路径
    output_path = f'../data/draw/d210191000/melt/L1L2L3node{NODE_ID}_speed_compare.png'
    ...
    '''
        ...
        {
            'file_path': '../data/draw/d210191000/melt/0129old_good/inference_results_all.csv',
            'label': '0129old_good',
            'color': 'gray',
            'linestyle': '--',
            'linewidth': 1,
        ...
        {
            'file_path': '../data/draw/d210191000/melt/0202l1/inference_results.csv',
            'label': '0202l1',
            'color': 'green',
            'linestyle': '--',
            'linewidth': 1,
        ...
        {
            'file_path': '../data/draw/d210191000/melt/0202l2/inference_results.csv',
            'label': '0202l2',
            'color': 'blue',
            'linestyle': '--',
            'linewidth': 1,
        ...
        {
            'file_path': '../data/draw/d210191000/melt/0302l1/inference_results.csv',
            'label': '0302l1',
            'color': 'green',
            'linestyle': '--',
            'linewidth': 1,
