...
# 测试数据（模型结果）CSV 路径
OUTPUT_CSV_PATH = r"../data/draw/d210191000/vs/physical_prior/physical_prior_predictions.csv"
...
REPORT_PATH: Optional[str] = r"../data/draw/d210191000/vs/physical_prior/all_metrics.csv"
