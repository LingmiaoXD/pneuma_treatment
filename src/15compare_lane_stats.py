...
# 测试数据（模型结果）CSV 路径
OUTPUT_CSV_PATH = r"E:\大学文件\研二\交通分析\代码\trafficWave-Net\output\0130加强了插值比重的\inference_results.csv"
...
REPORT_PATH: Optional[str] = r"E:\大学文件\研二\交通分析\代码\trafficWave-Net\output\0130加强了插值比重的\all_metrics.csv"
