...
def main():
    ...
    start_frame = 250
    end_frame = 600
    output_path = f'../data/draw/d210191000/obs_patrol/node{NODE_ID}_fscore_metrics.csv'
    transition_output_path = f'../data/draw/d210191000/obs_patrol/node{NODE_ID}_transition_metrics.csv'
