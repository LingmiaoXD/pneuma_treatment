...
if __name__ == "__main__":
    ...
    TRAJ_CSV_PATH = r"E:\大学文件\研二\交通分析\代码\pneuma_treatment\yolodata\ok_data\c0127085746_0002_aligned.csv"         # 轨迹数据，含 track_id,frame_number,corrected_x,corrected_y,width,height,class_name,speed_kmh 等字段
    OUTPUT_CSV = r"E:\大学文件\研二\交通分析\代码\pneuma_treatment\yolodata\trajectory_with_laneid\0127085746_0002.csv"          # 输出路径
